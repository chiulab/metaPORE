...
taxonomy_file="$base.human_subtracted.blastn.1hsp.gi.taxonomy"
...
paste "$base.human_subtracted.blastn.1hsp" "$taxonomy_file" > "$base.unified"
...
echo -e "$bacteria_reads Bacteria" 					>> "$base.all_reads.count"
echo -e "$nhEUK_reads non-Human Eukaryote" 			>> "$base.all_reads.count"
